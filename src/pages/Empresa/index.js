...
export default function Empresa(){
	...
	return (
		<>
			...
			<FlexboxGrid justify="center" className="parallaxEmpresa" style={{padding: '150px 5%', marginTop: '120px !important'}}>
				<FlexboxGrid.Item componentClass={Col} colspan={21} md={23} style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', marginTop: 80}}>
				...
				<FlexboxGrid justify="space-around">
					<FlexboxGrid.Item componentClass={Col} colspan={21} md={7} style={CardEmpresa}>
